spawn(function()
--hat u need https://www.roblox.com/catalog/5197851188/Red-Eternal-Slayer
print("you need a hat fo dis lol")
print("working net bypass???? :ooooo")
...
--Hat: https://www.roblox.com/catalog/5909776064/Russo-s-Sword-of-Truth
Bypass = "death"
loadstring(game:GetObjects("rbxassetid://5325226148")[1].Source)()
-----OPTIONS
local ToolName = "Red Eternal Slayer" ----- the hats name on explorer/dex (not name in catalog)
...
tl1.Color = ColorSequence.new(BrickColor.new('Persimmon').Color)
tl1.Lifetime = 0.8
tl1.Enabled = false
...
for i = 0, 4, 0.1 do
swait()
sphere2(5,"Add",larm.CFrame*CFrame.new(0,-1.5,0)*CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(1,1,1),-0.01,0.1,-0.01,BrickColor.new("Persimmon"),BrickColor.new("Persimmon").Color)
...
orb.Anchored = true
orb.BrickColor = BrickColor.new("Persimmon")
...
waveEff(2,"Add","Out",orb.CFrame*CFrame.Angles(math.rad(90),math.rad(math.random(-360,360)),0),vt(5,1,5),0.5,0.1,BrickColor.new("Persimmon"))
coroutine.resume(coroutine.create(function()
while true do
swait(2)
...
tl1.Color = ColorSequence.new(BrickColor.new('Persimmon').Color,BrickColor.new('Persimmon').Color)
tl1.Lifetime = 5
local tl2 = tl1:Clone()
...
for _i,v in pairs(game:GetService("Players").LocalPlayer.Character:GetDescendants()) do
