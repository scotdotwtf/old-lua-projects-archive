...
if game:IsLoaded() then
	...
	insperation.Text = "UI Inspired by Bobuxgod#4662"
	...
	ser6.Text = "ser6 - reanimates user for scripts [Selexity]"
	...
	ser62.Text = "ser6 - reanimates user for scripts [Selexity]"
	...
	nepvedit.Text = "redtunian - [perma death] loads nepv edit [edit by spec#9001]"
	...
	nepvedit2.Text = "redtunian - [perma death] loads nepv edit [edit by spec#9001]"
	...
	local uwus = {
		...
		["ser6"] = function()
			loadstring(game:HttpGet("https://raw.githubusercontent.com/specowos/adminware-v1.2/main/selexity%20reanim", true))()
		end,
